 ...
 *
 * program to reverse linked list in pairs using Iterative methode
 *
 * Lets understand with the help of simple example:
 * Lets say linkedlist is 5-> 6 -> 7 -> 1
 * If you look closely, below steps are just reversing link to  6->5->7->1 in first iteration
 * (Swapping node 6 and 5) and then advance to next pair (Node 7 and 1)
 */
public class ReverseLinkedListInPairIterative {
    ...
    public static void main(String[] args) {
        ReverseLinkedListInPairIterative list = new ReverseLinkedListInPairIterative();
